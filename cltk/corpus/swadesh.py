...
swadesh_fa = ["من","تو","او","ما","شما","ایشان, آنان","این","آن","اینجا","آنجا","که","چه","کجا","کی","چرا","نِـ, نَـ","همه","خیلی, بسیاری","بعضی, چند","کمی, اندکی","دیگر","یک","دو","سه","چهار","پنج","بزرگ","دراز","پهن, فراخ","کلفت","سنگین","کوچک","کوتاه","باریک","لاغر","زن","مرد","انسان, آدمی","بچه, کودک","زن","شوهر","مادر","پدر","حیوان, جانور","ماهی","پرنده, مرغ","سگ","شپش","مار","کرم","درخت","جنگل","چوب","میوه","بذر, تخم","برگ","ریشه","تنه","گل","چمن, علف","نخ","پوست","گوشت","خون","استخوان","چربی, پیه","تخم, خایه","شاخ","دم","پر","مو","سر","گوش","چشم","بینی","دهان","دندان","زبان","ناخن","پا","ساق","زانو","دست","بال","شکم","دل و روده, شکنبه","گردن","پشت","سینه","دل, قلب","جگر","نوشیدن","خوردن","جویدن","مکیدن","تف انداختن","استفراغ کردن","وزیدن, دمیدن","نفس کشیدن","خندیدن","دیدن","شنیدن","دانستن","اندیشیدن","بوییدن","ترسیدن","خوابیدن, خسبیدن","زیستن","مردن","کشتن","رزمیدن","شکار کردن","زدن","بریدن","شکافتن","فرو کردن","خاریدن","کندن","شنا کردن","پریدن","رفتن, شدن","آمدن","دراز کشیدن","نشستن","ایستادن","گشتن","افتادن","دادن","نگهداشتن","فشردن","مالیدن","شستن","زدودن, پاک کردن","کشیدن","فشار دادن, فشاردن","افکندن","بستن, گره زدن","دوختن","شمردن","گفتن","خواندن","بازی کردن, نواختن","شناور بودن","جاری بودن, شریدن","یخ زدن","باد کردن","خورشید","ماه","ستاره","آب","باران","رود","دریاچه","دریا","نمک","سنگ","شن","گرد","زمین","ابر","مه","آسمان","باد","برف","یخ","دود","آتش, آذر","خاکستر","سوختن","راه","کوه","سرخ, قرمز","سبز","زرد","سفید","سیاه","شب","روز","سال","گرم","سرد","پر","نو, جدید","کهن, پیر","خوب","بد, زشت","فاسد, پوسیده","پلید, چرکین","راست","گرد","تیز","کند","صاف","تر, نم","خشک","درست, راست","نزدیک","دور","راست","چپ","در","در, اندر","با","و","اگر","چون","نام"]
